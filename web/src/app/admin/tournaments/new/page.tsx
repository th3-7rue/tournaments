...
function SubmitButton() {
  ...
  return (
    <button
      ...
      type="submit"
      disabled={pending}
      className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-bold py-3.5 rounded-xl hover:from-blue-700 hover:to-indigo-700 transition shadow-md disabled:opacity-60 disabled:cursor-not-allowed flex items-center justify-center gap-2"
    >
      {pending ? (
        <>
  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <form action={formAction} className="bg-white p-6 sm:p-8 rounded-2xl shadow-sm border border-slate-100 space-y-5">
        ...
        <div>
          <label htmlFor="tournament-name" className="block text-sm font-semibold text-slate-700 mb-2">
        ...
        <div>
          <label htmlFor="tournament-description" className="block text-sm font-semibold text-slate-700 mb-2">Descrizione</label>
          <textarea
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
          <div>
            <label htmlFor="tournament-sport" className="block text-sm font-semibold text-slate-700 mb-2">Sport</label>
            <select
              id="tournament-sport"
              name="sport"
              value={sport}
          ...
          <div>
            <label htmlFor="tournament-format" className="block text-sm font-semibold text-slate-700 mb-2">Formato</label>
            <select
        ...
        {sport === 'VOLLEYBALL' && (
          <div className="bg-indigo-50 p-5 rounded-xl border border-indigo-100 animate-in fade-in duration-200">
            ...
            <div>
              <label htmlFor="volleyball-sets" className="block text-sm font-semibold text-indigo-800 mb-2">Formato Set</label>
              <select
                id="volleyball-sets"
                name="volleyballSets"
